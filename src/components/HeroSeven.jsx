    ...
    >
      ...
      >
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-0`}>
          amitamin® Ovarifert je alternativni tretman bez lijekova, zasnovan na
          sastojcima poput mio-inozitola, d-kiro-inozitola i alfa-lipoične
      ...
      >
        <img
          src={ovarifert}
          alt="billing"
          className="w-[85%] h-[95%] relative z-[5]"
        />
